...
- **Question 1 (Redpanda version)**: `v25.3.9`
- **Question 2 (Sending data)**: `300 seconds`
- **Question 3 (Consumer - trip distance)**: `8506`
- **Question 4 (Tumbling window - pickup location)**: `74`
- **Question 5 (Session window - longest streak)**: `31`
- **Question 6 (Tumbling window - largest tip)**: `2025-10-16 18:00:00`
